	...
	<div class="row">
		...
		<div class="col-md-8" style="margin-top:20px">
			<div class="row" style="border: 1px solid gray; box-shadow:1px 1px 1px gray">
				<div class="col-md-4">
				<br><br>
					<img src="IMAGES/profile-icon.png" style="height:150px; width:150px; margin-bottom:20px; float:right;" class="rounded-circle" />
				</div>
				<div class="col-md-8">
					<form action="uploadProfilePic" method="POST" enctype="multipart/form-data">
						<br>
						<h2 style="color:red; margin-top:40px;">Edit Profile Pic</h2>
						<br> <br>
						...
						<input type="submit" value="UPDATE PROFILE PIC" class="btn-success"><br><br>
					</form>
